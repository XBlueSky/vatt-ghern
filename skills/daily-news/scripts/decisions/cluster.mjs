#!/usr/bin/env node
// decisions/cluster.mjs — Group candidates that look like the same story
...
//
// Library use:
//   import { clusterCandidates } from "./decisions/cluster.mjs";
//   const clusters = clusterCandidates(candidates);
//
// CLI use:
//   cat candidates.json | node skills/daily-news/scripts/decisions/cluster.mjs
//   node skills/daily-news/scripts/decisions/cluster.mjs --in candidates.json
//
